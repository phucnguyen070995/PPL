...
func_type: primitive_type | primitive_type LS RS | VOIDTYPE;
func_name: ID;
one_para: primitive_type ID | primitive_type ID LS RS;
block_statement:LB (statements)* RB;
statements: var_decl | statement;
var_decl: primitive_type (one_variable (CM one_variable)* ) SEMI;
//var_decl: primitive_type one_variable SEMI;
