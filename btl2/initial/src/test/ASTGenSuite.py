...
Body:
    ...
    EndIf.
EndBody."""
        expect = """Program([FuncDecl(Id(test)[],([][If(BinaryOp(>,Id(n),IntLiteral(10)),[],[Return(Id(n))])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[Return(BinaryOp(+,Id(n),IntLiteral(1)))])ElseIf(BinaryOp(>,Id(n),IntLiteral(6)),[],[Return(BinaryOp(+,Id(n),IntLiteral(2)))])ElseIf(BinaryOp(>,Id(n),IntLiteral(4)),[],[Return(BinaryOp(+,Id(n),IntLiteral(3)))])ElseIf(BinaryOp(>,Id(n),IntLiteral(2)),[],[Return(BinaryOp(+,Id(n),IntLiteral(4)))])Else([],[])]))])"""
...
Body:
    ...
    EndFor.
EndBody."""
        expect = """Program([VarDecl(Id(x)),FuncDecl(Id(fact)[VarDecl(Id(n))],([VarDecl(Id(i)),VarDecl(Id(x),IntLiteral(0))][For(Id(i),IntLiteral(1),BinaryOp(<,Id(i),IntLiteral(3)),UnaryOp(-.,IntLiteral(5)),[],[Assign(Id(x),BinaryOp(+,Id(i),IntLiteral(7))),If(BinaryOp(>,Id(n),IntLiteral(100)),[],[Break()])Else([],[])])]))])"""
...
Body:
    ...
    EndFor.
EndBody."""
        expect = """Program([VarDecl(Id(x)),FuncDecl(Id(fact)[VarDecl(Id(n))],([][For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),UnaryOp(-.,IntLiteral(2)),[],[])]))])"""
...
Body:
    ...
    EndFor.
EndBody."""
        expect = """Program([VarDecl(Id(x)),FuncDecl(Id(fact)[VarDecl(Id(n))],([][For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[Return(IntLiteral(1)),Break(),Continue(),CallExpr(Id(foo),[BinaryOp(+,CallExpr(Id(float_of_int),[Id(a)]),IntLiteral(2))]),CallExpr(Id(goo),[BinaryOp(+,Id(a),IntLiteral(1))])])]))])"""
...
Body:
    ...
    x = n >=. z;
EndBody."""
        expect = """Program([VarDecl(Id(a),IntLiteral(5)),VarDecl(Id(b),[5]),VarDecl(Id(c)),VarDecl(Id(d),IntLiteral(6)),VarDecl(Id(e)),FuncDecl(Id(main)[],([][Assign(Id(x),BinaryOp(+,Id(y),BinaryOp(*.,BinaryOp(-,Id(z),Id(q)),IntLiteral(10)))),Assign(Id(x),BinaryOp(>=.,Id(n),Id(z)))]))])"""
...
Body:
    ...
    x = n >=. z;
EndBody."""
        expect = """Program([VarDecl(Id(a),IntLiteral(5)),VarDecl(Id(b),[5]),VarDecl(Id(c)),VarDecl(Id(d),IntLiteral(6)),VarDecl(Id(e)),FuncDecl(Id(main)[],([VarDecl(Id(b),[5]),VarDecl(Id(c)),VarDecl(Id(d),IntLiteral(6)),VarDecl(Id(e))][Assign(Id(x),BinaryOp(+,Id(y),BinaryOp(*.,BinaryOp(-,Id(z),Id(q)),IntLiteral(10)))),Assign(Id(x),BinaryOp(>=.,Id(n),Id(z)))]))])"""
...
EndBody."""
        expect = """Program([FuncDecl(Id(main)[],([][While(BooleanLiteral(true),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])]))])"""
...
Body:
    ...
    x = n >=. z;
EndBody."""
        expect = """Program([VarDecl(Id(a),StringLiteral(a string)),VarDecl(Id(b),[5]),VarDecl(Id(c)),VarDecl(Id(d),IntLiteral(6)),VarDecl(Id(e)),FuncDecl(Id(main)[],([][Assign(Id(x),BinaryOp(+,Id(y),BinaryOp(*.,BinaryOp(-,Id(z),Id(q)),IntLiteral(10)))),Assign(Id(x),BinaryOp(>=.,Id(n),Id(z)))]))])"""
...
Body:
    ...
    x = n >=. z;
EndBody."""
        expect = """Program([VarDecl(Id(a),StringLiteral(a string)),VarDecl(Id(b),[5]),VarDecl(Id(c)),VarDecl(Id(d),IntLiteral(6)),VarDecl(Id(e)),FuncDecl(Id(main)[],([][Assign(Id(x),BinaryOp(+.,BinaryOp(+,Id(y),BinaryOp(*.,BinaryOp(-,Id(z),Id(q)),IntLiteral(10))),FloatLiteral(100.0))),Assign(Id(x),BinaryOp(>=.,Id(n),Id(z)))]))])"""
...
EndWhile.
EndBody."""
        expect = """Program([VarDecl(Id(x)),VarDecl(Id(y),FloatLiteral(2.0)),VarDecl(Id(z),FloatLiteral(3.5)),FuncDecl(Id(you)[VarDecl(Id(x)),VarDecl(Id(y),[5])],([VarDecl(Id(a)),VarDecl(Id(b)),VarDecl(Id(c),StringLiteral(string)),VarDecl(Id(a),BooleanLiteral(false))][If(BinaryOp(==,Id(z),BooleanLiteral(true)),[],[Return(IntLiteral(1))])Else([],[]),While(BooleanLiteral(true),[],[CallExpr(Id(foo),[]),CallExpr(Id(goo),[Id(a)]),Break()])]))])"""
...
EndFor.
EndBody."""
        expect = """Program([VarDecl(Id(x)),VarDecl(Id(y),IntLiteral(1)),VarDecl(Id(z),FloatLiteral(3.5)),VarDecl(Id(t)),VarDecl(Id(sp)),VarDecl(Id(yz)),FuncDecl(Id(you)[VarDecl(Id(q)),VarDecl(Id(d),[5])],([VarDecl(Id(a),StringLiteral(string)),VarDecl(Id(b)),VarDecl(Id(c),BooleanLiteral(false))][CallExpr(Id(foo),[BinaryOp(+,Id(a),Id(c))]),If(BinaryOp(==,Id(z),BooleanLiteral(true)),[],[Assign(Id(x),ArrayCell(Id(d),[BinaryOp(-.,BinaryOp(+.,BinaryOp(*.,Id(y),Id(z)),Id(t)),BinaryOp(\,Id(c),IntLiteral(10)))])),Return(IntLiteral(1))])ElseIf(BinaryOp(!=,Id(x),FloatLiteral(400000.0)),[],[Assign(Id(x),BinaryOp(+,BinaryOp(-,BinaryOp(*,BinaryOp(+,Id(a),Id(b)),Id(y)),Id(z)),BinaryOp(*.,Id(sp),Id(yz))))])Else([],[Continue()]),While(BooleanLiteral(true),[],[CallExpr(Id(foo),[]),CallExpr(Id(goo),[Id(a)]),Break()]),For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),UnaryOp(-,IntLiteral(2)),[],[Assign(Id(x),Id(i))])]))])"""
...
Body:                                       
    ...
    print(x + y);
EndBody."""
        expect = """Program([VarDecl(Id(a)),FuncDecl(Id(main)[VarDecl(Id(q)),VarDecl(Id(d),[5])],([][Assign(Id(x),BinaryOp(+,CallExpr(Id(foo),[IntLiteral(171)]),CallExpr(Id(goo),[IntLiteral(10)]))),Assign(Id(y),CallExpr(Id(foo),[BinaryOp(+,Id(x),CallExpr(Id(goo),[BooleanLiteral(true)]))])),CallExpr(Id(print),[BinaryOp(+,Id(x),Id(y))])]))])"""
...
Body:                                       
    ...
    print(x + y);
EndBody."""
        expect = """Program([VarDecl(Id(a)),FuncDecl(Id(main)[VarDecl(Id(q)),VarDecl(Id(d),[5])],([][Assign(Id(x),BinaryOp(+,CallExpr(Id(foo),[StringLiteral(ahihi)]),CallExpr(Id(goo),[IntLiteral(10)]))),Assign(Id(y),CallExpr(Id(foo),[BinaryOp(+,Id(x),CallExpr(Id(goo),[BooleanLiteral(true)]))])),CallExpr(Id(print),[BinaryOp(+,Id(x),Id(y))])]))])"""
...
Body:                                       
    ...
    print(x + y);
EndBody."""
        expect = """Program([VarDecl(Id(uh)),FuncDecl(Id(main)[VarDecl(Id(q)),VarDecl(Id(d),[5])],([][Assign(Id(x),BinaryOp(+,CallExpr(Id(foo),[StringLiteral(ahihi)]),CallExpr(Id(goo),[IntLiteral(10)]))),Assign(Id(y),CallExpr(Id(foo),[BinaryOp(+,Id(x),CallExpr(Id(goo),[BooleanLiteral(true)]))])),CallExpr(Id(print),[BinaryOp(+,Id(x),Id(y))])]))])"""
...
Parameter: q , d[5]
    ...
    print(x + y);
EndBody."""
        expect = """Program([VarDecl(Id(a)),FuncDecl(Id(main)[VarDecl(Id(q)),VarDecl(Id(d),[5])],([VarDecl(Id(x)),VarDecl(Id(y),IntLiteral(1)),VarDecl(Id(z),FloatLiteral(3.5))][If(BinaryOp(&&,BinaryOp(>,Id(a),Id(b)),BinaryOp(<,Id(c),Id(d))),[],[Break()])Else([],[]),Assign(Id(x),BinaryOp(+,CallExpr(Id(foo),[StringLiteral(ahihi)]),CallExpr(Id(goo),[IntLiteral(10)]))),Assign(Id(y),CallExpr(Id(foo),[BinaryOp(+,Id(x),CallExpr(Id(goo),[BooleanLiteral(true)]))])),CallExpr(Id(print),[BinaryOp(+,Id(x),Id(y))])]))])"""
...
Body:
    ...
    EndWhile.
EndBody."""
        expect = """Program([VarDecl(Id(x)),FuncDecl(Id(fact)[VarDecl(Id(n)),VarDecl(Id(y))],([][While(BinaryOp(==,ArrayCell(Id(n),[IntLiteral(1)]),ArrayCell(Id(a),[IntLiteral(2)])),[],[Break()])]))])"""
...
Body:
    ...
    EndDo.
EndBody."""
        expect = """Program([VarDecl(Id(a),IntLiteral(0)),FuncDecl(Id(main)[],([][Dowhile([],[Dowhile([],[Dowhile([],[CallExpr(Id(print),[StringLiteral(Hello World!)])],BinaryOp(>,Id(a),Id(b))),CallExpr(Id(print),[StringLiteral(Hello World!)])],BinaryOp(>,Id(a),Id(b))),CallExpr(Id(print),[StringLiteral(Hello World!)])],BinaryOp(>,Id(a),Id(b)))]))])"""
...
Body:
    ...
    EndWhile.
EndBody."""
        expect = """Program([VarDecl(Id(a),IntLiteral(0)),FuncDecl(Id(main)[],([][While(BinaryOp(<=,Id(a),UnaryOp(-,IntLiteral(5))),[],[CallExpr(Id(print),[StringLiteral(Hello World!)]),While(BinaryOp(<=,Id(a),UnaryOp(-,IntLiteral(5))),[],[CallExpr(Id(print),[StringLiteral(Hello World!)]),While(BinaryOp(<=,Id(a),UnaryOp(-,IntLiteral(5))),[],[CallExpr(Id(print),[StringLiteral(Hello World!)]),While(BinaryOp(<=,Id(a),UnaryOp(-,IntLiteral(5))),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])])])])]))])"""
...
Body:
    ...
    EndWhile.
EndBody."""
        expect = """Program([VarDecl(Id(a),IntLiteral(0)),FuncDecl(Id(main)[],([][While(BinaryOp(<=,Id(a),UnaryOp(-,IntLiteral(5))),[],[CallExpr(Id(print),[StringLiteral(Hello World!)]),While(BinaryOp(<=,Id(a),UnaryOp(-,IntLiteral(5))),[],[Dowhile([],[Dowhile([],[Dowhile([],[CallExpr(Id(print),[StringLiteral(Hello World!)])],BinaryOp(>,Id(a),Id(b))),CallExpr(Id(print),[StringLiteral(Hello World!)])],BinaryOp(>,Id(a),Id(b))),CallExpr(Id(print),[StringLiteral(Hello World!)])],BinaryOp(>,Id(a),Id(b))),CallExpr(Id(print),[StringLiteral(Hello World!)]),While(BinaryOp(<=,Id(a),UnaryOp(-,IntLiteral(5))),[],[CallExpr(Id(print),[StringLiteral(Hello World!)]),While(BinaryOp(<=,Id(a),UnaryOp(-,IntLiteral(5))),[],[Dowhile([],[Dowhile([],[Dowhile([],[CallExpr(Id(print),[StringLiteral(Hello World!)])],BinaryOp(>,Id(a),Id(b))),CallExpr(Id(print),[StringLiteral(Hello World!)])],BinaryOp(>,Id(a),Id(b))),CallExpr(Id(print),[StringLiteral(Hello World!)])],BinaryOp(>,Id(a),Id(b))),CallExpr(Id(print),[StringLiteral(Hello World!)])])])])])]))])"""
...
Body:
    ...
    EndFor.
EndBody."""
        expect = """Program([VarDecl(Id(x)),FuncDecl(Id(fact)[VarDecl(Id(n))],([][For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[CallExpr(Id(print),[StringLiteral(Hello World!)]),For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),UnaryOp(-,IntLiteral(2)),[],[For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[CallExpr(Id(print),[StringLiteral(Hello World!)]),For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])]),CallExpr(Id(print),[StringLiteral(Hello World!)])])]),CallExpr(Id(print),[StringLiteral(Hello World!)])])])]))])"""
...
Body:
    ...
    EndFor.
EndBody."""
        expect = """Program([VarDecl(Id(x)),FuncDecl(Id(fact)[VarDecl(Id(n))],([][For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[If(BinaryOp(&&,BinaryOp(>,Id(a),Id(b)),BinaryOp(<,Id(c),Id(d))),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),UnaryOp(-.,IntLiteral(2)),[],[For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[If(BinaryOp(&&,BinaryOp(>,Id(a),Id(b)),BinaryOp(<,Id(c),Id(d))),[],[If(BinaryOp(&&,BinaryOp(>,Id(a),Id(b)),BinaryOp(<,Id(c),Id(d))),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[])]),CallExpr(Id(print),[StringLiteral(Hello World!)])]),If(BinaryOp(&&,BinaryOp(>,Id(a),Id(b)),BinaryOp(<,Id(c),Id(d))),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[])]),CallExpr(Id(print),[StringLiteral(Hello World!)])])])]))])"""
...
Body:
    ...
    EndFor.
EndBody."""
        expect = """Program([VarDecl(Id(x)),FuncDecl(Id(fact)[VarDecl(Id(n))],([][For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[If(BinaryOp(&&,BinaryOp(>,Id(a),Id(b)),BinaryOp(<,Id(c),Id(d))),[],[Break()])Else([],[]),For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),UnaryOp(-,IntLiteral(2)),[],[If(BinaryOp(&&,BinaryOp(==,Id(a),Id(b)),BinaryOp(<,Id(c),Id(d))),[],[Break()])Else([],[])]),CallExpr(Id(print),[StringLiteral(Hello World!)])])])]))])"""
...
Body:
    ...
    EndIf.
EndBody."""
        expect = """Program([FuncDecl(Id(test)[],([][If(BinaryOp(>,Id(n),IntLiteral(10)),[],[If(BinaryOp(>,Id(n),IntLiteral(10)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[If(BinaryOp(>,Id(n),IntLiteral(10)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[If(BinaryOp(>,Id(n),IntLiteral(10)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[If(BinaryOp(>,Id(n),IntLiteral(10)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(2)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[CallExpr(Id(print),[StringLiteral(Hello World!)])])]))])"""
...
Body:
    ...
    EndIf.
EndBody."""
        expect = """Program([FuncDecl(Id(test)[],([][If(BinaryOp(>,Id(n),IntLiteral(10)),[],[If(BinaryOp(>,Id(n),IntLiteral(10)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[If(BinaryOp(>,Id(n),IntLiteral(10)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[If(BinaryOp(!=,Id(n),IntLiteral(10)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[If(BinaryOp(>,Id(n),IntLiteral(10)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[])]))])"""
...
Body:
    ...
    a = a + - 1 + - 5 - -5;
EndBody."""
        expect = """Program([VarDecl(Id(x)),FuncDecl(Id(fact)[VarDecl(Id(n))],([][Assign(Id(x),ArrayCell(Id(d),[BinaryOp(-.,BinaryOp(+.,BinaryOp(*.,Id(y),Id(z)),Id(t)),BinaryOp(\,Id(c),IntLiteral(10)))])),Assign(ArrayCell(Id(b),[IntLiteral(2),IntLiteral(3)]),ArrayLiteral(ArrayLiteral(IntLiteral(2),IntLiteral(3),IntLiteral(4)),ArrayLiteral(IntLiteral(4),IntLiteral(5),IntLiteral(6)))),Assign(ArrayCell(Id(a),[BinaryOp(+,IntLiteral(3),CallExpr(Id(foo),[IntLiteral(2)]))]),BinaryOp(+,ArrayCell(Id(a),[ArrayCell(Id(b),[IntLiteral(2),IntLiteral(3)])]),IntLiteral(4))),Assign(Id(v),BinaryOp(*.,BinaryOp(*.,BinaryOp(*.,BinaryOp(*.,BinaryOp(\.,FloatLiteral(4.0),FloatLiteral(3.0)),FloatLiteral(3.14)),Id(r)),Id(r)),Id(r))),Assign(Id(x),CallExpr(Id(foo),[BinaryOp(+,ArrayCell(Id(a),[IntLiteral(1),IntLiteral(2)]),IntLiteral(2)),BinaryOp(+,Id(x),IntLiteral(1))])),Assign(Id(x),BinaryOp(+,Id(y),BinaryOp(*.,BinaryOp(-,Id(z),Id(q)),IntLiteral(10)))),Assign(Id(x),BinaryOp(>=.,Id(n),Id(z))),Assign(Id(x),ArrayCell(Id(d),[BinaryOp(-.,BinaryOp(+.,BinaryOp(*.,Id(y),Id(z)),Id(t)),BinaryOp(\,Id(c),IntLiteral(10)))])),Assign(Id(x),BinaryOp(+,BinaryOp(-,BinaryOp(*,BinaryOp(+,Id(a),Id(b)),Id(y)),Id(z)),BinaryOp(*.,Id(sp),Id(yz)))),Assign(Id(a),BinaryOp(-,BinaryOp(+,BinaryOp(+,Id(a),UnaryOp(-,IntLiteral(1))),UnaryOp(-,IntLiteral(5))),UnaryOp(-,IntLiteral(5))))]))])"""
...
Body:
    ...
    a = a + - 1 + - 5 - -5;
EndBody."""
        expect = """Program([VarDecl(Id(x)),FuncDecl(Id(fact)[VarDecl(Id(n))],([][Assign(Id(x),ArrayCell(Id(d),[BinaryOp(-.,BinaryOp(+.,BinaryOp(*.,Id(y),Id(z)),Id(t)),BinaryOp(\,Id(c),IntLiteral(10)))])),Assign(ArrayCell(Id(b),[IntLiteral(2),IntLiteral(3)]),ArrayLiteral(ArrayLiteral(IntLiteral(2),IntLiteral(3),IntLiteral(4)),ArrayLiteral(IntLiteral(4),IntLiteral(5),IntLiteral(6)))),Assign(ArrayCell(Id(a),[BinaryOp(+,IntLiteral(3),CallExpr(Id(foo),[IntLiteral(2)]))]),BinaryOp(+,ArrayCell(Id(a),[ArrayCell(Id(b),[IntLiteral(2),IntLiteral(3)])]),IntLiteral(4))),Assign(Id(v),BinaryOp(!=,BinaryOp(*.,BinaryOp(\.,FloatLiteral(4.0),FloatLiteral(3.0)),FloatLiteral(3.14)),BinaryOp(*.,BinaryOp(*.,Id(r),Id(r)),Id(r)))),Assign(Id(x),CallExpr(Id(foo),[BinaryOp(+,ArrayCell(Id(a),[IntLiteral(1),IntLiteral(2)]),IntLiteral(2)),BinaryOp(+,Id(x),IntLiteral(1))])),Assign(Id(x),BinaryOp(+,Id(y),BinaryOp(*.,BinaryOp(-,Id(z),Id(q)),IntLiteral(10)))),Assign(Id(x),BinaryOp(>=.,Id(n),Id(z))),Assign(Id(x),ArrayCell(Id(d),[BinaryOp(-.,BinaryOp(+.,BinaryOp(*.,Id(y),Id(z)),Id(t)),BinaryOp(\,Id(c),IntLiteral(10)))])),Assign(Id(x),BinaryOp(+,BinaryOp(-,BinaryOp(*,BinaryOp(+,Id(a),Id(b)),Id(y)),Id(z)),BinaryOp(*.,Id(sp),Id(yz)))),Assign(Id(a),BinaryOp(-,BinaryOp(+,BinaryOp(+,Id(a),UnaryOp(-,IntLiteral(1))),UnaryOp(-,IntLiteral(5))),UnaryOp(-,IntLiteral(5))))]))])"""
    ...
    def test_all_52(self):
        input = """Function: foo
            ...
            Body:
                ...
                EndIf.
            EndBody."""
        expect = """Program([FuncDecl(Id(foo)[VarDecl(Id(a)),VarDecl(Id(b)),VarDecl(Id(c))],([][If(BinaryOp(<,Id(a),Id(b)),[],[While(BooleanLiteral(true),[],[Break()])])ElseIf(BinaryOp(==,Id(a),Id(b)),[],[For(Id(i),IntLiteral(1),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(1),[],[CallExpr(Id(foo),[CallExpr(Id(foo),[CallExpr(Id(foo),[])])])])])Else([],[Dowhile([],[Continue()],BinaryOp(=/=,BinaryOp(\.,Id(a),FloatLiteral(10.0)),FloatLiteral(10.5)))])]))])"""
    ...
    def test_all_53(self):
        input = """Function: foo
            ...
            Body:
                ...
                EndIf.
            EndBody."""
        expect = """Program([FuncDecl(Id(foo)[VarDecl(Id(a)),VarDecl(Id(b)),VarDecl(Id(c))],([][Assign(Id(a),IntLiteral(1193046)),If(BinaryOp(<,Id(a),Id(b)),[],[While(BooleanLiteral(true),[],[Break()])])ElseIf(BinaryOp(==,Id(a),Id(b)),[],[For(Id(i),IntLiteral(1),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(1),[],[CallExpr(Id(foo),[CallExpr(Id(foo),[CallExpr(Id(foo),[IntLiteral(5)])])])])])Else([],[Dowhile([],[Dowhile([],[Continue()],BinaryOp(=/=,BinaryOp(\.,Id(a),FloatLiteral(10.0)),FloatLiteral(0.0105)))],BinaryOp(=/=,BinaryOp(\.,Id(a),FloatLiteral(10.0)),FloatLiteral(0.0105)))])]))])"""
...
EndBody."""
        expect = """Program([VarDecl(Id(x)),FuncDecl(Id(fact)[VarDecl(Id(n))],([][Assign(Id(x),ArrayCell(Id(d),[BinaryOp(-.,BinaryOp(+.,BinaryOp(*.,Id(y),Id(z)),Id(t)),BinaryOp(\,Id(c),IntLiteral(10)))])),Assign(ArrayCell(Id(b),[IntLiteral(2),IntLiteral(3)]),ArrayLiteral(ArrayLiteral(IntLiteral(2),IntLiteral(3),IntLiteral(4)),ArrayLiteral(IntLiteral(4),IntLiteral(5),IntLiteral(6)))),Assign(ArrayCell(Id(a),[BinaryOp(+,IntLiteral(3),CallExpr(Id(foo),[ArrayCell(Id(a),[BinaryOp(+,IntLiteral(3),CallExpr(Id(foo),[ArrayCell(Id(a),[BinaryOp(+,IntLiteral(3),CallExpr(Id(foo),[IntLiteral(2)]))])]))])]))]),BinaryOp(+,ArrayCell(Id(a),[ArrayCell(Id(b),[ArrayCell(Id(a),[BinaryOp(+,IntLiteral(3),CallExpr(Id(foo),[IntLiteral(2)]))]),IntLiteral(3)])]),IntLiteral(4)))]))])"""
...
Body:
    ...
    EndFor.
EndBody."""
        expect = """Program([VarDecl(Id(x)),FuncDecl(Id(fact)[VarDecl(Id(n))],([][For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[If(BinaryOp(&&,BinaryOp(>,Id(a),Id(b)),BinaryOp(<,Id(c),Id(d))),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),UnaryOp(-,IntLiteral(2)),[],[If(BinaryOp(>=,BinaryOp(!=,Id(a),Id(b)),BinaryOp(<,Id(c),Id(d))),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[])]),CallExpr(Id(print),[StringLiteral(Hello World!)])])])]))])"""
...
EndBody."""
    ...
    def test_all_63(self):
        ...
        EndBody.
        """
        expect = """Program([VarDecl(Id(i),[123,1,2],ArrayLiteral(ArrayLiteral(IntLiteral(2),IntLiteral(3),IntLiteral(4)),ArrayLiteral(IntLiteral(4),IntLiteral(5),IntLiteral(6)))),FuncDecl(Id(main)[VarDecl(Id(a)),VarDecl(Id(b))],([VarDecl(Id(r),FloatLiteral(10.0)),VarDecl(Id(v))][If(BinaryOp(==,BinaryOp(+,IntLiteral(5),IntLiteral(2)),IntLiteral(3)),[VarDecl(Id(a))],[Assign(Id(a),BinaryOp(+,Id(x),IntLiteral(3)))])ElseIf(BinaryOp(==,BinaryOp(+,IntLiteral(5),IntLiteral(2)),IntLiteral(3)),[VarDecl(Id(a))],[Assign(Id(a),BinaryOp(+,Id(x),IntLiteral(3)))])ElseIf(BinaryOp(==,BinaryOp(+,IntLiteral(5),IntLiteral(2)),IntLiteral(3)),[VarDecl(Id(a))],[Assign(Id(a),BinaryOp(+,Id(x),IntLiteral(3)))])Else([VarDecl(Id(a))],[Assign(Id(a),BinaryOp(+,Id(x),IntLiteral(3)))])]))])"""
    ...
    def test_all_65(self):
        input = """
            ...
            EndBody.
            """
        expect = """Program([VarDecl(Id(i),[123,1,2],ArrayLiteral(ArrayLiteral(IntLiteral(2),IntLiteral(3),IntLiteral(4)),ArrayLiteral(IntLiteral(4),IntLiteral(5),IntLiteral(6)))),FuncDecl(Id(main)[VarDecl(Id(a)),VarDecl(Id(b))],([VarDecl(Id(a),IntLiteral(5)),VarDecl(Id(b),[2,3],ArrayLiteral(ArrayLiteral(IntLiteral(2),IntLiteral(3),IntLiteral(4)),ArrayLiteral(IntLiteral(4),IntLiteral(5),IntLiteral(6)))),VarDecl(Id(c)),VarDecl(Id(d),IntLiteral(6)),VarDecl(Id(e)),VarDecl(Id(f)),VarDecl(Id(m)),VarDecl(Id(n),[10]),VarDecl(Id(r),FloatLiteral(10.0)),VarDecl(Id(v))][If(BinaryOp(==,BinaryOp(+,IntLiteral(5),IntLiteral(2)),IntLiteral(3)),[VarDecl(Id(a)),VarDecl(Id(b))],[Assign(Id(a),BinaryOp(+,Id(x),IntLiteral(3))),Assign(Id(a),BinaryOp(+,Id(x),IntLiteral(3)))])ElseIf(BinaryOp(==,BinaryOp(+,IntLiteral(5),IntLiteral(2)),IntLiteral(3)),[VarDecl(Id(a)),VarDecl(Id(b))],[Assign(Id(a),BinaryOp(+,Id(x),IntLiteral(3))),Assign(Id(a),BinaryOp(+,Id(x),IntLiteral(3)))])ElseIf(BinaryOp(==,BinaryOp(+,IntLiteral(5),IntLiteral(2)),IntLiteral(3)),[VarDecl(Id(a)),VarDecl(Id(b))],[Assign(Id(a),BinaryOp(+,Id(x),IntLiteral(3))),Assign(Id(a),BinaryOp(+,Id(x),IntLiteral(3)))])Else([VarDecl(Id(a)),VarDecl(Id(b))],[Assign(Id(a),BinaryOp(+,Id(x),IntLiteral(3))),Assign(Id(a),BinaryOp(+,Id(x),IntLiteral(3)))])]))])"""
    ...
    def test_all_66(self):
        ...
        EndBody.
        """
        expect = """Program([VarDecl(Id(x),IntLiteral(5)),FuncDecl(Id(main)[],([VarDecl(Id(a),IntLiteral(5)),VarDecl(Id(b),[2,3],ArrayLiteral(ArrayLiteral(IntLiteral(2),IntLiteral(3),IntLiteral(4)),ArrayLiteral(IntLiteral(4),IntLiteral(5),IntLiteral(6)))),VarDecl(Id(c)),VarDecl(Id(d),IntLiteral(6)),VarDecl(Id(e)),VarDecl(Id(f)),VarDecl(Id(m)),VarDecl(Id(n),[10])][Assign(Id(x),IntLiteral(10)),CallExpr(Id(printLn),[Id(x)]),Continue()]))])"""
...
Body:
    ...
    EndIf.
EndBody."""
        expect = """Program([VarDecl(Id(b),[2,3],ArrayLiteral(ArrayLiteral(IntLiteral(2),IntLiteral(3),IntLiteral(4)),ArrayLiteral(IntLiteral(4),IntLiteral(5),IntLiteral(6)))),VarDecl(Id(c)),VarDecl(Id(d),IntLiteral(6)),VarDecl(Id(e)),VarDecl(Id(f)),VarDecl(Id(m)),VarDecl(Id(n),[10]),FuncDecl(Id(test)[],([VarDecl(Id(b),[2,3],ArrayLiteral(ArrayLiteral(IntLiteral(2),IntLiteral(3),IntLiteral(4)),ArrayLiteral(IntLiteral(4),IntLiteral(5),IntLiteral(6)))),VarDecl(Id(c)),VarDecl(Id(d),IntLiteral(6)),VarDecl(Id(e)),VarDecl(Id(f)),VarDecl(Id(m)),VarDecl(Id(n),[10])][If(BinaryOp(>,Id(n),IntLiteral(10)),[],[If(BinaryOp(>,Id(n),IntLiteral(10)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[If(BinaryOp(>,Id(n),IntLiteral(10)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[If(BinaryOp(!=,Id(n),IntLiteral(10)),[],[CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>,Id(n),IntLiteral(8)),[],[If(BinaryOp(>,Id(n),IntLiteral(10)),[],[While(BinaryOp(<,Id(i),IntLiteral(5)),[],[Assign(ArrayCell(Id(a),[Id(i)]),BinaryOp(+.,Id(b),FloatLiteral(1.0))),Assign(Id(i),BinaryOp(+,Id(i),IntLiteral(1)))]),Assign(Id(x),ArrayCell(Id(d),[BinaryOp(-.,BinaryOp(+.,BinaryOp(*.,Id(y),Id(z)),Id(t)),BinaryOp(\,Id(c),IntLiteral(10)))])),Assign(ArrayCell(Id(b),[IntLiteral(2),IntLiteral(3)]),ArrayLiteral(ArrayLiteral(IntLiteral(2),IntLiteral(3),IntLiteral(4)),ArrayLiteral(IntLiteral(4),IntLiteral(5),IntLiteral(6)))),Assign(ArrayCell(Id(a),[BinaryOp(+,IntLiteral(3),CallExpr(Id(foo),[IntLiteral(2)]))]),BinaryOp(+,ArrayCell(Id(a),[ArrayCell(Id(b),[IntLiteral(2),IntLiteral(3)])]),IntLiteral(4))),Assign(Id(v),BinaryOp(*.,BinaryOp(*.,BinaryOp(*.,BinaryOp(*.,BinaryOp(\.,FloatLiteral(4.0),FloatLiteral(3.0)),FloatLiteral(3.14)),Id(r)),Id(r)),Id(r))),Assign(Id(x),CallExpr(Id(foo),[BinaryOp(+,ArrayCell(Id(a),[IntLiteral(1),IntLiteral(2)]),IntLiteral(2)),BinaryOp(+,Id(x),IntLiteral(1))])),Assign(Id(x),BinaryOp(+,Id(y),BinaryOp(*.,BinaryOp(-,Id(z),Id(q)),IntLiteral(10)))),Assign(Id(x),BinaryOp(>=.,Id(n),Id(z))),Assign(Id(x),ArrayCell(Id(d),[BinaryOp(-.,BinaryOp(+.,BinaryOp(*.,Id(y),Id(z)),Id(t)),BinaryOp(\,Id(c),IntLiteral(10)))])),Assign(Id(x),BinaryOp(+,BinaryOp(-,BinaryOp(*,BinaryOp(+,Id(a),UnaryOp(-,Id(b))),Id(y)),Id(z)),BinaryOp(*.,Id(sp),Id(yz)))),Assign(Id(a),BinaryOp(-,BinaryOp(+,BinaryOp(+,Id(a),UnaryOp(-,IntLiteral(1))),UnaryOp(-,IntLiteral(5))),UnaryOp(-,IntLiteral(5)))),CallExpr(Id(print),[StringLiteral(Hello World!)])])ElseIf(BinaryOp(>=.,Id(n),BinaryOp(-.,IntLiteral(8),Id(a))),[],[For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[If(BinaryOp(&&,BinaryOp(>,Id(a),Id(b)),BinaryOp(<,Id(c),Id(d))),[],[Break()])Else([],[]),For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),UnaryOp(-,IntLiteral(2)),[],[If(BinaryOp(&&,BinaryOp(==,Id(a),Id(b)),BinaryOp(<,Id(c),Id(d))),[],[Break()])Else([],[])]),CallExpr(Id(print),[StringLiteral(Hello World!)])])]),CallExpr(Id(print),[StringLiteral(Hello World!)]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),While(BinaryOp(<,Id(i),IntLiteral(5)),[],[Assign(ArrayCell(Id(a),[Id(i)]),BinaryOp(+.,Id(b),FloatLiteral(1.0))),Assign(Id(i),BinaryOp(+,Id(i),IntLiteral(1))),CallExpr(Id(foo),[BinaryOp(+,ArrayCell(Id(a),[IntLiteral(1),IntLiteral(2)]),IntLiteral(2)),BinaryOp(+,Id(x),IntLiteral(1))]),CallExpr(Id(foo),[BinaryOp(+,IntLiteral(2),Id(x)),BinaryOp(\.,FloatLiteral(4.0),Id(y))]),CallExpr(Id(goo),[]),If(CallExpr(Id(bool_of_string),[StringLiteral(True)]),[],[Assign(Id(a),CallExpr(Id(int_of_string),[CallExpr(Id(read),[])])),Assign(Id(b),BinaryOp(+.,CallExpr(Id(float_of_int),[Id(a)]),FloatLiteral(2.0))),Dowhile([],[Dowhile([],[Dowhile([],[CallExpr(Id(print),[StringLiteral(Hello World!)])],BinaryOp(>,Id(a),Id(b))),CallExpr(Id(print),[StringLiteral(Hello World!)])],BinaryOp(>,Id(a),Id(b))),CallExpr(Id(print),[StringLiteral(Hello World!)])],BinaryOp(>,Id(a),Id(b))),CallExpr(Id(foo),[BinaryOp(+,ArrayCell(Id(a),[IntLiteral(1),IntLiteral(2)]),IntLiteral(2)),BinaryOp(+,Id(x),IntLiteral(1))]),CallExpr(Id(foo),[BinaryOp(+,IntLiteral(2),Id(x)),BinaryOp(\.,FloatLiteral(4.0),Id(y))]),CallExpr(Id(goo),[])])Else([],[])]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),For(Id(i),IntLiteral(0),BinaryOp(<,Id(i),IntLiteral(10)),IntLiteral(2),[],[Return(IntLiteral(1)),Break(),Continue(),CallExpr(Id(foo),[BinaryOp(+,CallExpr(Id(float_of_int),[Id(a)]),IntLiteral(2))]),CallExpr(Id(goo),[BinaryOp(+,Id(a),IntLiteral(1))])]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[]),CallExpr(Id(print),[StringLiteral(Hello World!)])])Else([],[])]))])"""
